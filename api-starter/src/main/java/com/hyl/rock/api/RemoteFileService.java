...
import com.hyl.rock.api.factory.RemoteFileFallbackFactory;
 ...
 * 
 */
@FeignClient(contextId = "remoteFileService", value = "system-service", fallbackFactory = RemoteFileFallbackFactory.class)
public interface RemoteFileService
{
    ...
    Result<Boolean> delete(@RequestParam("fileUrl") String fileUrl);
}
